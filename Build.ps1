param(
    ...
    [Switch] $notouch,
    [String] $project = "ReflectSoftware.Insight.Extensions.EnterpriseLibrary5"
)
...
function Invoke-NuGetPack($version)
{
    ...
    pushd .\src
    Invoke-NuGetPackSpec "ReflectSoftware.Insight.Extensions.EnterpriseLibrary5.nuspec" $version
    popd
}
